...
https://github.com/dv0retsky/secur-tutorial/blob/main/MZI9_XSS-CSRF/MZI9_XSS-CSRF.md
...
## ♨️ Почему браузер доверяет коду страницы
...
## ♨️ Практика: Reflected XSS в MiniBank
...
## ♨️ Уязвимость гостевой книги MiniBank
...
## ♨️ Почему Stored XSS особенно опасен
...
## ♨️ Практика: демонстрация CSRF в локальной лаборатории
...
## ♨️ Защита с помощью CSRF-токена
...
## ♨️ Практика: демонстрация Clickjacking
...
## ♨️ Почему одной защиты недостаточно
...
## ♨️ Защищённая конфигурация заголовков
...
## ♨️ Защищённый вывод пользовательского текста
